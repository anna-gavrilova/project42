...
public class DirectionsData extends AsyncTask<Object,String,String> {
    ...
    DirectionsData(Context c){this.c=c;}
    ...
    protected String doInBackground(Object... params) {
        ...
        url=(String)params[1];
        startLL=(LatLng)params[2];
        endLL=(LatLng)params[3];
